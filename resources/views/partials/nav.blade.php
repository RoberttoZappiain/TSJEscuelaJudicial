    ...
    <div class="container-fluid linedown " >
        ...
        <ul class="mx nav nav-fill" style="background-color: #dbad3a !important">
            <li class="nav-item {{ setActive('inicio.*')}}">
                <a class="nav-link active " href="http://tsjescuelajudicialnay.herokuapp.com/inicio"><svg class="mr-1 " style="margin-top: -5px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-house  mt-2" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                    <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                </svg>Inicio</a>
            </li>
            <li class="nav-item {{ setActive('curso.index')}}">
                <a class="nav-link " href="http://tsjescuelajudicialnay.herokuapp.com/curso"><svg class="mr-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-book mt-2  " viewBox="0 0 16 16">
            ...
            <li class="nav-item  {{ setActive('perfil.*')}}">
                <a class="nav-link" href="http://tsjescuelajudicialnay.herokuapp.com/perfil"><svg class="mr-1" style="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4c0d0d" class="bi bi-person " viewBox="0 0 16 16">
