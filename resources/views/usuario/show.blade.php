...
@section('content')
    ...
    <div class="container " >
        <div class="row" >
            <div class="col-12 col-sm-12 col-lg-4 col-xl-4 mt-2 " style="">
                ...
                <img class="img-fluid rounded text-center offset-4" src="/storage/{{$usuario->imagen_perfil}}" alt="Card image cap" style="max-height: 250px">
                ...
                <div class="col-12">
                  ...
                  <div class="col-10 mt-2">
                    ...
                    <ul class="nav nav-tabs text-center" >
                        <li class="active ml-3 text-center"><a style="padding: 0px !important" id="CP1" href="#tab-1">
                        ...
                        <li class="ml-3"><a id="CP2" style="padding: 0px !important" href="#tab-2"><svg id="check2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" style="visibility: hidden"  viewBox="0 0 16 16">
                            <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
                          </svg>COPIA CERTIFICADA CEDULA/TITULO |</a></li>

                         <li class="ml-3"><a id="CP3" style="padding: 0px !important" href="#tab-3"><svg id="check3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" style="visibility: hidden"  viewBox="0 0 16 16">
                            <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
                          </svg>COPIA CREDENCIAL DEL ELECTOR |</a></li>

                        <li class="ml-3"><a id="CP4" style="padding: 0px !important" href="#tab-4">
                        ...
                        <li class="ml-3"><a id="CP5"  style="padding: 0px !important" href="#tab-5"><svg id="check5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" style="visibility: hidden"  viewBox="0 0 16 16">
                            <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
                          </svg>FOTOGRAFIAS TAMAÑO CREDENCIAL BLANCO Y NEGRO |</a></li>
                        <li class="ml-3"><a id="CP6" style="padding: 0px !important" href="#tab-6"><svg id="check6" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" style="visibility: hidden"  viewBox="0 0 16 16">
                            <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
